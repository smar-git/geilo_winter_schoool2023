---
title: "Bayesian Statistics with R-INLA - Part 3"
...
```{r, out.width = "100%"}
include_graphics("graphics3/inla-structure.pdf")
```
...
include_graphics("graphics3/01fig-009.pdf")
```
:::
...
## 
```{r, out.width = "70%"}
include_graphics("graphics3/results-0125.pdf")
```
\scriptsize 
...
## 
```{r, out.width = "70%"}
include_graphics("graphics3/results-025.pdf")
```
\scriptsize 
Running time of INLA $<0.5$ seconds
\normalsize 
...
## 
```{r, out.width = "70%"}
include_graphics("graphics3/results-05.pdf")
```
\scriptsize 
Running time of INLA $<0.5$ seconds
\normalsize 
...
## 
```{r, out.width = "70%"}
include_graphics("graphics3/results-2.pdf")
```
\scriptsize 
Running time of INLA $<0.5$ seconds
\normalsize 
...
## 
```{r, out.width = "70%"}
include_graphics("graphics3/results-4.pdf")
```
\scriptsize 
Running time of INLA $<0.5$ seconds
\normalsize 
...
## 
```{r, out.width = "70%"}
include_graphics("graphics3/results-8.pdf")
```
\scriptsize 
Running time of INLA $<0.5$ seconds
\normalsize 
...
## 
```{r, out.width = "70%"}
include_graphics("graphics3/results-16.pdf")
```
\scriptsize 
Running time of INLA $<0.5$ seconds
\normalsize 
...
## 
```{r, out.width = "70%"}
include_graphics("graphics3/results-32.pdf")
```
\scriptsize 
Running time of INLA $<0.5$ seconds
\normalsize 
...
## 
```{r, out.width = "70%"}
include_graphics("graphics3/results-64.pdf")
```
\scriptsize 
Running time of INLA $<0.5$ seconds
\normalsize 
...
## 
```{r, out.width = "70%"}
include_graphics("graphics3/results-120.pdf")
```
\scriptsize 
Running time of INLA $<0.5$ seconds
\normalsize 
